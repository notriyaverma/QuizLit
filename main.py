...
from doc.process import DocumentProcessor
from embed.embed import EmbeddingClient
from chroma.chroma import ChromaCollectionCreator
from quiz_gen.gen import QuizGenerator
from quiz_manager.manager import QuizManager

if __name__ == "__main__":
    
    embed_config = {
        "model_name": "textembedding-gecko@003",
        "project": "fluted-factor-426117-s8",
    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                topic_input = st.text_input("Topic for Generative Quiz", placeholder = "Enter topic of the document")
                questions = st.slider("Number of Question", min_value = 1, max_value = 15, value = 3)
                ##### YOUR CODE HERE #####
